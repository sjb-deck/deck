...
class CheckForAlertsTestCase(TestCase):
    def setUp(self):
        ...
        # Create test data
        self.item1 = Item.objects.create(name="Item1", total_quantity=5, min_quantity=10)
        self.item2 = Item.objects.create(name="Item2", total_quantity=20, min_quantity=15)
        self.item3 = Item.objects.create(name="Item3", total_quantity=8, min_quantity=8)
        self.item4 = Item.objects.create(name="Item4", total_quantity=5, min_quantity=10)
    ...
    def test_low_quantity_items(self):
        ...
        self.assertIn({"name": self.item1.name, "total_quantity": self.item1.total_quantity}, low_quantity_items)
        self.assertIn({"name": self.item3.name, "total_quantity": self.item3.total_quantity}, low_quantity_items)
        self.assertIn({"name": self.item4.name, "total_quantity": self.item4.total_quantity}, low_quantity_items)
    ...
    def test_expired_items(self):
        ...
        self.assertIn({"name": self.item1.name, "expiry_date": self.expired_item_expiry.expiry_date.strftime('%Y-%m-%d'), "quantity": self.expired_item_expiry.quantity, "status": "expired"}, expired_items)
        self.assertIn({"name": self.item4.name, "expiry_date": self.expired_item_2_expiry.expiry_date.strftime('%Y-%m-%d'), "quantity": self.expired_item_2_expiry.quantity, "status": "expired"}, expired_items)
    ...
    def test_expiring_items(self):
        ...
        self.assertIn({"name": self.item2.name, "expiry_date": self.expiring_item_expiry.expiry_date.strftime('%Y-%m-%d'), "quantity": self.expiring_item_expiry.quantity, "status": "expiring"}, expiring_items)
    ...
    def test_no_alerts_with_items(self):
        ...
        self.clear_database()
        self.item5 = Item.objects.create(name="Item5", total_quantity=20, min_quantity=10)
        self.item6 = Item.objects.create(name="Item6", total_quantity=15, min_quantity=10)
        current_date = timezone.now()
