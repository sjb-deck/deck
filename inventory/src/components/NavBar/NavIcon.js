...
import { URL_INV_INDEX, URL_INV_ITEMS, URL_INV_VIEW_KITS } from '../../globals';
...
export const NavIcon = () => {
  ...
  const getIconClickUrl = () => {
    if (isIndexPage || isLoanPage) return URL_INV_INDEX;
    ...
    <>
      <Breadcrumbs aria-label='breadcrumb' style={{ flexGrow: 1 }}>
        <StyledBreadcrumb
          ...
          label='Home'
          icon={
            <img height={20} src='/static/inventory/img/logo.png' alt='logo' />
          }
        />
        <StyledBreadcrumb
          component='a'
