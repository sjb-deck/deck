...
const App = () => {
  ...
  const submitForm = () => {
    $.ajax({
      ...
      success: function (data) {
        window.location.href = (data.to_redirect == "None" ? "/" : data.to_redirect);
      },
  ...
  return (
    <div className="login-div">
      <img src="/static/inventory/img/St John Singapore Logo (Inverted, Transparent Background).png"></img>
